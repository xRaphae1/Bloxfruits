...
S:AddToggle({
	...
	Default = true,
	Callback = function(Value)
		local SuperFastMode = Value -- Change to true if you want Super Super Super Fast attack (Like instant kill) but it will make the game kick you more than normal mode
